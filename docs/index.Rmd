...
subtitle: "Supplementary materials for the paper: 'cranscrub: an R-package for scrubbing the CRAN downloads logs into a polished state' "
author:
  - name: Danyang Dai 
    affiliation: Department of Econometrics and Business Statistics, Monash University, Melbourne, VIC 3800
    email: danyangdai@monash.edu
  - name: Emi Tanaka
    affiliation: Department of Econometrics and Business Statistics, Monash University, Melbourne, VIC 3800
...
- [Checking for accuracy of the processed data with the `cranlogs` package]. 
...
```{r connectDB, cache=TRUE, include=FALSE,class.source = 'fold-show'}
library(DBI)
...
```{r datecontinue, cache=TRUE, class.source = 'fold-show'}
...
## Checking for duplicated dates {#id}
...
```{r nonmatchexample, cache=TRUE, class.source = 'fold-show'}
library(lubridate)
...
```{r nonmatch, cache=TRUE, class.source = 'fold-show'}
...
## Checking for accuracy of the processed data with the `cranlogs` package {#id}
...
```{r downloadsamefiles,message=FALSE,cache=TRUE,warning=FALSE,class.source = 'fold-show', eval = FALSE}
...
```{r processedvscranlog, message=FALSE,cache=TRUE,warning=FALSE,class.source = 'fold-show'}
...
```{r,eval = FALSE, message=FALSE,cache=TRUE,warning=FALSE,class.source = 'fold-show'}
...
```{r, message=FALSE,cache=TRUE,warning=FALSE,class.source = 'fold-show'}
