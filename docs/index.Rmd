---
title: "Appendix for R package downloads"
author:
  - name: Danyang Dai 
...
- [Two dates recorded in one cranlog file]. 
- [Cross referece processed data with the `cranlogs` package]. 
...
## Two dates recorded in one cranlog file {#id}
...
## Cross referece processed data with the `cranlogs` package {#id}
